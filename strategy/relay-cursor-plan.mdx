...
| Claude + Codex + failover | Combined [child #7](/strategy/relay-post-core-integrations-plan) Phase 1 (done injected; live CLI remaining) |
| Mini launchd + Tailscale | #6 |
| Jobs + promote | Combined [child #7](/strategy/relay-post-core-integrations-plan) Phase 2 (done injected; live staging remaining) |
