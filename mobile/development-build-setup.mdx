...
Once a dev client is installed, you can iterate with fast refresh, React Native Debugger, native modules, and on-device testing without rebuilding from scratch for every JS change.

<CardGroup cols={2}>
  <Card title="OTA updates" icon="cloud-arrow-up" href="/mobile/ota-updates">
    EAS Update channels, publishing JS-only updates, and Expo references.
  </Card>
  <Card title="Mobile analytics" icon="chart-column" href="/mobile/analytics">
    Event tracking and batching from the Meridian mobile app.
  </Card>
  <Card title="Authentication overview" icon="shield" href="/backend/auth/overview">
    Google, Apple, and token flows the mobile client uses with the backend.
  </Card>
  <Card title="Getting started" icon="rocket" href="/getting-started">
    **Meridian** clone setup and env vars aligned with **Meridian-Mobile** (separate repo; often a sibling folder).
  </Card>
  <Card title="Shuttle tracker" icon="bus" href="/mobile/shuttle-tracker">
    Campus shuttle integration consumed from the mobile app.
  </Card>
  <Card title="Testing" icon="flask" href="/testing">
    CI and conventions when mobile features touch the Meridian backend.
  </Card>
</CardGroup>
