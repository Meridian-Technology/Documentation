...
<Note>
CMS parity modules (governance docs, budgets, accounting dimensions, and inventory)
are documented in `/atlas/cms-parity-spec` and are designed to be tenant-configurable.
</Note>
