...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more in the [API reference introduction](/api-reference/introduction).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more in the [API reference introduction](/api-reference/introduction)
        </ResponseField>
      </Expandable>
    </ResponseField>
